...
class Mobileapi extends CI_Controller
{
    ...
    public function getInspectionReportHistory($userId) {
        $crudeData = $this->inspection->getInspectionReportHistory($userId);
        ...
        foreach ( $crudeData as $item ) {
            ...
            if ($item['activityId'] != $activityId) {
                ...
                $activity = array('id' => $item['activityId'],
                    ...
                    'imageUrls' => array());
                array_push($response[$projectIndex]['stage'][$stageIndex]['activity'],
                $activity);
                $imageUrl = null;
            }
            ...
            if (strcmp($imageUrl, $item['imageUrl']) !== 0) {
                ...
                array_push($response[$projectIndex]['stage'][$stageIndex]['activity'][$activityIndex]['imageUrls'], $imageUrl);
            }
        }
