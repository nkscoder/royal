        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
				...
				<ul class="treeview-menu">
                <li><a href="<?php echo base_url('project/')?>"><i class="fa fa-circle-o"></i> <span>Project</span></a></li>
				...
				<li><a href="<?php echo base_url('project/projectEmployee'); ?>"><i
                    ...
                    <li><a href="<?php echo base_url('project/projectEmployee'); ?>"><i
                                    class="fa fa-circle-o"></i>Add stage to employee</a></li>
                    <li><a href="<?php echo base_url('project/projectstatus'); ?>"><i
                                    class="fa fa-circle-o"></i>Project Status</a></li>
				</ul>
				</li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url('report/projectreport')?>"><i class="fa fa-circle-o"></i> <span>Project Report</span></a></li>
                    </ul>
                </li>
