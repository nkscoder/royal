                        ...
                        <div class="box-body">
                            ...
                            <table id="example_cilent" class="table display" width="100%" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td><a type="button" id="<?php echo $row['id']; ?>" onclick="display_value(this.id);" class="btn btn-primary" style="display: inline" data-toggle="modal" data-target="#exampleModalc">
