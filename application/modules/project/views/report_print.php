...
<html><head>
    ...
    <style>
        ...
        .invoice-box .bill-table{
            width: 40%;
        }

        .invoice-box .comm-table{
            width: 60%;
        }
        ...
        <td colspan="5">
            <table>
                <tr>
                    ...
                    <td class="heading-1">
                       BUCON TECHNOLOGY ( BUSINESS CONTROL TECHNOLOGY)
        ...
        <td colspan="5">
            <table>
                <tr>
                    <td>
                        501, Ajay Avenue, <br>
                        Ashiyana Digha Road, Patna-25  <br>
                        Phone: 9473144754     <br>
                        Email: info@bucontechnology.in      <br>
                        Website: http://bucontechnology.in/royal/     <br>
...
<!--    <table  class="comm-table" style="margin-top:30px;">-->
<!---->
<!--        <tr class="heading">-->
<!--            <td>-->
<!--                Other Comments-->
...
<!---->
<!--            <td>-->
<!--                This fee is Non-Refundable or Non-Transfarable under any circumstances.-->
<!--            </td>-->
<!---->
<!---->
<!---->
