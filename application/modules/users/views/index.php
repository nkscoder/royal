    ...
    <div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin" method="POST" action="<?php echo base_url().'users/login'?>">
                ...
                <input type="text"  name="email" id="user_name" class="form-control" placeholder="User name" required autofocus>
...
<!--                type: "POST",-->
<!--                url: "index.php",-->
<!--                data: { action: 'load_post',email: email, password:password },-->
...
<!--                    //     alert(1234);-->
<!--                    // }-->
<!--                    window.location.replace("http://localhost/royal/view/dashbord.php");-->
<!--                }-->
<!--            });-->
<!--        }-->
<!---->
